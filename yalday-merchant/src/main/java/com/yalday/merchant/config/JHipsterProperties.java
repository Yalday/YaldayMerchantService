...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "yaldayMerchant@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "yaldayMerchant API";

        private String description = "yaldayMerchant API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "yaldayMerchant";
